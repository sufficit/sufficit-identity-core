...
namespace Sufficit.AI
{
    ...
    /// Verification: use HasPolicy(principal, new AIControlEntitlement()) to check possession
    /// on any context, or HasPolicy&lt;AIControlEntitlement&gt;(principal, contextId) to scope
    ...
    public class AIControlEntitlement : Entitlement
    {
        ...
        // No role association — entitlement possession alone grants management access
