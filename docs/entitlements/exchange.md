...
1 entitlement(s). The identifiers below are published constants of
this library, not operational data.

| Key | Type | Name | ID | Self-context |
| --- | --- | --- | --- | --- |
| `exchangemanager` | `ExchangeManagerEntitlement` | acesso a gerencia de exchange | `2c45c5acf6a66d86babc1ed8c6ccc83b` | — |
