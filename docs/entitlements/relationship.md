...
| --- | --- | --- | --- | --- |
| `contactdeny` | `ContactUpdateDenyDirective` | não alterar contato | `9a989de2-1f97-449c-af29-6e12d4d91491` | — |
| `groupcontacts` | `GroupContactsDirective` | visualizar contatos por grupo | `26b32b5b-7ac1-4324-9b71-83559bac1f1d` | — |
