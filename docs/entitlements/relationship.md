...
| --- | --- | --- | --- | --- |
| `contactdeny` | `ContactUpdateDenyEntitlement` | não alterar contato | `9a989de21f97449caf296e12d4d91491` | — |
| `groupcontacts` | `GroupContactsEntitlement` | visualizar contatos por grupo | `26b32b5b7ac143249b7183559bac1f1d` | — |
